...
do
    ...
    # time ./katago selfplay -max-games-total "$NUM_GAMES_PER_CYCLE" -output-dir "$BASEDIR"/selfplay -models-dir "$BASEDIR"/../kata9x9-b18c384nbt/models -config "$BASEDIR"/../kata9x9-b18c384nbt/selfplay1_maxsize9.cfg | tee -a "$BASEDIR"/selfplay/stdout.txt
