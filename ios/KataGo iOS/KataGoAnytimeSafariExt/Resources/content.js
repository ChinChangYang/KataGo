...
<div class="kga-root">
  ...
  <div class="kga-msg" hidden></div>
        ...
        /// single-page app: OGS renders a different layout when the window
        /// changes shape, and the column the panel sat in is unmounted with the
        /// panel inside it. So an in-flow panel is re-placed once a second.
        /// Once the element has been missing for a whole second, or when the
        /// selector does not parse, the panel docks, and it goes back into the
        /// flow when the element returns.
        placePanel() {
        ...
        onPlayerUpdate(payload) {
            ...
            this.message(this.refusal
                || (this.onMainline ? "" : "Viewing a variation — analysis follows the main line."));
            this.pushOverlays();
